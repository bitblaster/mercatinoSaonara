...
<P STYLE="margin: 0cm; font-size:14px;">In questa sezione è possibile:</P>
<UL>
...
<P STYLE="margin: 0cm; font-size:14px;">Se ti interessa un libro ma non è disponibile alcuna copia in vendita puoi richiedere di essere notificato con un'email non appena un utente la mette in vendita. Per farlo seleziona il libro e premi il pulsante <IMG SRC="mercatino/images/wishlist_add.png" WIDTH=24 HEIGHT=24 BORDER=0></P><br/>
<P STYLE="margin: 0cm; font-size:14px;">Se per un dato libro è presente una copia e vuoi contattare il venditore per acquistarla, seleziona il libro, poi seleziona la copia che vuoi prenotare e premi il pulsante <IMG SRC="mercatino/images/prenota_add.png" WIDTH=24 HEIGHT=24 BORDER=0>. Ti sarà  inviata una mail con i dati del venditore e a lui una mail con i tuoi dati. Potrete così contattarvi e concordare la vendita.</P><br/>
<P STYLE="margin: 0cm; font-size:14px;">Se hai una copia di un libro fra quelli previsti per l'anno <%= annoCorrente + "/" + (annoCorrente+1) %> e vuoi metterla in vendita seleziona il libro e premi il tasto <IMG SRC="mercatino/jwolfgwt/images/insert.png" WIDTH=27 HEIGHT=24 BORDER=0>. Compila il modulo indicando lo stato del tuo libro ed eventuali note. Il libro verrà così inserito nella base dati ed eventuali utenti che lo cercavano saranno notificati con una mail.</P><br/>
